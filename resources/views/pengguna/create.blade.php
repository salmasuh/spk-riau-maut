  ...
  <form method="POST" action="{{ route('users.store') }}">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
      ...
      <div>
        ...
        <input type="text" name="username" value="{{ old('username') }}" class="w-full p-3 border rounded" required>
      </div>

      <div>
        <label class="block text-sm text-gray-700">Password (min 8 karakter, termasuk huruf besar, huruf kecil, dan angka)</label>
